...
///////////////////////////////////POST DESCRICAO///////////////////////////////////
    ...
    public void cadastrarDescricao(final Descricao descricao){
        ...
        }else if(descricao.getFotos()== null){
            throw new RuntimeException("Fotos nula, verifique e tente novamente");
        }
        else{
...
///////////////////////////////////PUT DESCRICAO///////////////////////////////////
    public Descricao atualizarDescricao(Long id, Descricao descricaoAtualizada) {
        ...
        if (descricaoExistente == null) {
            ...
            descricaoExistente.setFotos(descricaoAtualizada.getFotos());
